/*
  ...
  - You are about to drop the column `experienceInYears` on the `doctor` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "doctor" DROP COLUMN "experienceInYears",
