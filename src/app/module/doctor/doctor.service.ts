...
import { Doctor, Prisma } from "../../../generated/client/client";
...
//Soft Delete: mark the doctor as deleted and also mark the associated user as deleted, but do not remove the records from the database. This allows for data retention and potential recovery in the future if needed.
